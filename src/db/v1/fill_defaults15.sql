...
;
insert into dict.cls_standart_period(name, date_create, number,
    id_user_creator,
...
;
insert into dict.cls_arbitary_period(name, date_create, number,
    id_user_creator,
    id_standart_period,
    id_region,
    id_district,
...
values (base.default_name(), '-infinity', base.default_number(),
    base.get_default_relation('accs.cls_user'),
    base.get_default_relation('dict.cls_standart_period'),
    base.get_default_relation('dict.cls_region'),
    base.get_default_relation('dict.cls_district'),
    base.get_default_relation('dict.cls_organization'),
    '-infinity', 'infinity'
