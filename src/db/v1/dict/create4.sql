...
create table if not exists dict.cls_standart_period
(
    id bigserial    primary key,
...
create table if not exists dict.cls_arbitary_period
(
    id bigserial        primary key,
    id_standart_period  bigint not null,
    id_region           bigint not null,
    id_district         bigint not null,
    ...
    constraint fk_id_standart_period    foreign key (id_standart_period)    references dict.cls_standart_period (id)
)
inherits (base.base_classifier)
;
